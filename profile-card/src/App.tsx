...
function App() {
  return (
    <>
      <main className="min-h-screen w-full flex flex-col items-center py-[200px]  bg-gradient-to-b from-gray-50 to-[#d2d6db]">
        <div className="w-[340px] flex flex-col gap-10 bg-white px-4 py-6 rounded-lg">
          <section className="flex flex-col items-center gap-6 self-stretch text-center">
            ...
            <div>
              <p className="font-medium text-xl text-neutral-900 mb-1">
                Sarah Dole
              </p>
          ...
          <section>
            <a
              href="#"
              className="font-medium px-4 py-2.5 rounded bg-indigo-700 text-white text-center w-full block mb-6 hover:bg-indigo-700/90"
            >
              Contact me
            </a>
              ...
              <div className="p-2 rounded">
                <a href="#">
                  <div className="w-5 h-5">
                    <svg
                      className="fill-indigo-700 hover:fill-indigo-700/90"
                      viewBox="0 0 20 20"
                ...
                <a href="#">
                  <div className="w-5 h-5">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <path d="M15.1707 1.875H17.9273L11.9048 8.75833L18.9898 18.125H13.4423L9.09733 12.4442L4.12569 18.125H1.36736L7.80903 10.7625L1.01236 1.875H6.70069L10.6282 7.0675L15.1707 1.875ZM14.2032 16.475H15.7307L5.87069 3.43833H4.23153L14.2032 16.475Z" />
                    </svg>
                  </div>
                </a>
              </div>
